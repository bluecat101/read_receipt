...
class Calendar(ttk.Frame):
    ...
    def __init__(self, master=None, **kw):
        ...
        self._properties = {"cursor": curs,
                            ...
                            'weekendbackground': 'blue', ###cahge
                            'weekendforeground': 'white',###cahge
                            'weekendbackground_2': 'red',###cahge
                            'weekendforeground_2': 'white',###cahge
    ...
    def _setup_style(self, event=None):
        ...
        we2_bg = self._properties.get('weekendbackground_2')###cahge
        we2_fg = self._properties.get('weekendforeground_2')###cahge
        ...
        self.style.configure('we.%s.TLabel' % self._style_prefixe, background=we_bg,
                             foreground=we_fg)
        self.style.configure('we2.%s.TLabel' % self._style_prefixe, background=we2_bg,
                             foreground=we2_fg)###cahge
    ...
    def _display_days_with_othermonthdays(self):
        ...
        week_days[self['weekenddays'][0] - 1] = 'we'  ###cahge
        week_days[self['weekenddays'][1] - 1] = 'we2' ###cahge
        prev_m = (month - 2) % 12 + 1
